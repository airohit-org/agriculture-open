package com.airohit.agriculture.module.system.controller.app.socail;
...
@Api(tags = "农场app - 社交用户")
@RestController
@RequestMapping("/system/app/social-user")
@Validated
public class AppSocialUserController {
    ...
    @PostMapping("/bind")
    @ApiOperation("(已登录用)社交绑定，使用 code 授权码")
