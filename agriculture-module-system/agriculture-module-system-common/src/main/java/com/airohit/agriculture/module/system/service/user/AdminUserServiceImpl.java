...
import com.airohit.agriculture.module.system.dal.dataobject.dept.UserPostDO;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Override
    @TenantIgnore
    public void updateUserPasswordNotLogin(Long id, UserProfileUpdatePasswordReqVO reqVO) {
        // 校验旧密码密码
