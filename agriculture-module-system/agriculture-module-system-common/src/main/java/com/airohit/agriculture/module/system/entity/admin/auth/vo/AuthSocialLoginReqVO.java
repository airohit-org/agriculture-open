...
public class AuthSocialLoginReqVO {
    ...
    @ApiModelProperty(value = "社交平台的类型,微信公众平台值为31", required = true, example = "10", notes = "参见 UserSocialTypeEnum 枚举值")
    @InEnum(SocialTypeEnum.class)
    @NotNull(message = "社交平台的类型不能为空")
    private Integer type;

    @ApiModelProperty(value = "授权码,全局唯一只能使用一次", required = true, example = "1024")
    @NotEmpty(message = "授权码不能为空")
    private String code;

    @ApiModelProperty(value = "state", required = false, example = "9b2ffbc1-7425-4155-9894-9d5c08541d62")
