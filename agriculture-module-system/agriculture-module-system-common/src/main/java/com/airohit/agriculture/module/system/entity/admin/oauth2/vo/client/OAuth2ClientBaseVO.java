...
public class OAuth2ClientBaseVO {
    ...
    @ApiModelProperty(value = "应用图标", required = true, example = "https://www.airohit.cn/xx.png")
    ...
    @ApiModelProperty(value = "可重定向的 URI 地址", required = true, example = "https://www.airohit.cn")
