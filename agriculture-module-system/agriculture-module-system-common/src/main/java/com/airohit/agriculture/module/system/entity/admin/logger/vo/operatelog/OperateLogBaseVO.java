package com.airohit.agriculture.module.system.entity.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @ApiModelProperty(value = "操作明细", example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从农业改成源码。")
    ...
    @ApiModelProperty(value = "Java 方法名", required = true, example = "com.airohit.agriculture.adminserver.UserController.save(...)")
