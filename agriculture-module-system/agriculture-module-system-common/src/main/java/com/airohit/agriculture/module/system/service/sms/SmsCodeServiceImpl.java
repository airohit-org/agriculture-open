...
import com.airohit.agriculture.module.system.dal.dataobject.sms.SmsCodeDO;
import com.airohit.agriculture.module.system.dal.dataobject.user.AdminUserDO;
import com.airohit.agriculture.module.system.dal.mysql.sms.SmsCodeMapper;
...
import com.airohit.agriculture.module.system.framework.sms.SmsCodeProperties;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        // 校验是否可以发送验证码，不用筛选场景
        SmsCodeDO lastSmsCode = smsCodeMapper.selectOne(new LambdaQueryWrapperX<SmsCodeDO>()
                .eq(SmsCodeDO::getMobile, mobile)
                .eqIfPresent(SmsCodeDO::getScene, null)
                .eqIfPresent(SmsCodeDO::getCode, null)
        ...
        if (lastSmsCode != null) {
            ...
            // TODO shiminghao：提升，每个 IP 每天可发送数量
            // TODO shiminghao：提升，每个 IP 每小时可发送数量
        }
    ...
    @Override
    public Long checkSmsCodeApp(SmsCodeCheckReqVo reqDTO) {
        //TODO 修改为测试专用
//        if (!"999999".equals(reqDTO.getCode())){
//            throw ServiceExceptionUtil.exception(SMS_CODE_NOT_FOUND);
//        }
        SmsCodeDO smsCodeDO = checkSmsCode0(reqDTO.getMobile(), reqDTO.getCode(), reqDTO.getScene());
        smsCodeMapper.updateById(SmsCodeDO.builder().id(smsCodeDO.getId())
