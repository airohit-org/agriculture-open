...
public class SmsChannelBaseVO {
    ...
    @ApiModelProperty(value = "短信签名", required = true, example = "shiminghao")
    ...
    @ApiModelProperty(value = "短信 API 的账号", required = true, example = "agriculture")
    ...
    @ApiModelProperty(value = "短信发送回调 URL", example = "http://www.airohit.cn")
