...
import com.airohit.agriculture.module.system.dal.mysql.dept.DeptMapper;
...
import com.airohit.agriculture.module.system.enums.dept.DeptIdEnum;
...
public class DeptServiceImpl implements DeptService {
    ...
    private volatile ImmutableMap<Long, DeptDO> deptCache;
    /**
     * 父部门缓存
    ...
    public List<DeptDO> getDeptsByParentIdFromCache(Long parentId, boolean recursive) {
        ...
        List<DeptDO> result = new ArrayList<>(); // TODO shiminghao：待优化，新增缓存，避免每次遍历的计算
        // 递归，简单粗暴
