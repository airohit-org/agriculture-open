package com.airohit.agriculture.module.system.entity.admin.oauth2.vo.user;
...
public class OAuth2UserInfoRespVO {
    ...
    @ApiModelProperty(value = "用户昵称", required = true, example = "shiminghao")
    private String username;

    @ApiModelProperty(value = "用户昵称", required = true, example = "农业")
    private String nickname;

    @ApiModelProperty(value = "用户邮箱", example = "agriculture@airohit.cn")
    ...
    @ApiModelProperty(value = "用户头像", example = "https://www.airohit.cn/xxx.png")
