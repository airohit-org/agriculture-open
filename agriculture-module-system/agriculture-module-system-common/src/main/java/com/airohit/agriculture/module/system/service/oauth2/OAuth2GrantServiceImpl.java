...
import com.airohit.agriculture.module.system.enums.ErrorCodeConstants;
...
public class OAuth2GrantServiceImpl implements OAuth2GrantService {
    ...
    public OAuth2AccessTokenDO grantClientCredentials(String clientId, List<String> scopes) {
        // TODO shiminghao：项目中使用 OAuth2 解决的是三方应用的授权，内部的 SSO 等问题，所以暂时不考虑 client_credentials 这个场景
