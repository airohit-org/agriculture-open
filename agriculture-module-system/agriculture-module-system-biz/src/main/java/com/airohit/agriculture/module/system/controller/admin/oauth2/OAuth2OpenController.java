...
import com.airohit.agriculture.framework.common.util.json.JsonUtils;
import com.airohit.agriculture.framework.operatelog.core.annotations.OperateLog;
import com.airohit.agriculture.module.system.convert.oauth2.OAuth2OpenConvert;
import com.airohit.agriculture.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.airohit.agriculture.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.airohit.agriculture.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.airohit.agriculture.module.system.entity.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.airohit.agriculture.module.system.entity.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.airohit.agriculture.module.system.entity.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.airohit.agriculture.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.airohit.agriculture.module.system.service.oauth2.OAuth2ApproveService;
import com.airohit.agriculture.module.system.service.oauth2.OAuth2ClientService;
import com.airohit.agriculture.module.system.service.oauth2.OAuth2GrantService;
import com.airohit.agriculture.module.system.service.oauth2.OAuth2TokenService;
import com.airohit.agriculture.module.system.util.oauth2.OAuth2Utils;
...
import static com.airohit.agriculture.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.airohit.agriculture.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static com.airohit.agriculture.framework.common.pojo.CommonResult.success;
import static com.airohit.agriculture.framework.common.util.collection.CollectionUtils.convertList;
...
public class OAuth2OpenController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "redirect_uri", value = "重定向 URI", example = "https://www.airohit.cn", dataTypeClass = String.class),
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "redirect_uri", required = true, value = "重定向 URI", example = "https://www.airohit.cn", dataTypeClass = String.class),
