package com.airohit.agriculture.module.system.api.logger.dto;
...
public class OperateLogCreateReqDTO {
    ...
    @ApiModelProperty(value = "Java 方法名", required = true, example = "com.airohit.agriculture.UserController.save(...)")
