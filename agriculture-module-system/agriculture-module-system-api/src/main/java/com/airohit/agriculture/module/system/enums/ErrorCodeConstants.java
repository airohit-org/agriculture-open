...
public interface ErrorCodeConstants {
    ...
    // ========== AUTH 模块 1002000000 ==========
    ErrorCode AUTH_LOGIN_BAD_CREDENTIALS = new ErrorCode(1002000000, "账号密码不正确");
    ...
    // ========== 短信验证码 1002014000 ==========
    ErrorCode SMS_CODE_NOT_FOUND = new ErrorCode(1002014000, "验证码不正确");
    ...
    ErrorCode WEIXIN_ERROR = new ErrorCode(500, "获取失败");
    ...
    ErrorCode SOCIAL_USER_AUTH_FAILURE_MSG = new ErrorCode(1002018000, "授权失败，请重新进入");
    ...
    ErrorCode FARM_NOT_EXISTS = new ErrorCode(500, "农场不存在");
    ErrorCode TENANT_NOT_USE_FARM = new ErrorCode(50000, "农场未关联租户");
    ErrorCode FARM_ALREADY_USE = new ErrorCode(500, "农场已被占用");
    ErrorCode TENANT_ALREADY_USE = new ErrorCode(500, "租户已被占用");
    ErrorCode TENANT_IS_NULL = new ErrorCode(500, "必须选择一个租户");
    ErrorCode PEASANT_FAIl = new ErrorCode(500, "必填数据没填");

    ErrorCode PEASANT_PROVINCE_FAIL = new ErrorCode(500, "省级单位格式或者名称不对");
    ErrorCode PEASANT_CITY_FAIL = new ErrorCode(500, "市级单位格式或者名称不对");
    ErrorCode PEASANT_AREA_FAIL = new ErrorCode(500, "区县级单位格式或者名称不对");


    String PRIVATE_KAY = "";
    String PUBLIC_KSY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCujrpp9j3j+cjhP9+OYeaoh87hxh0mmM6Qr5foAtcBm1ayw0dpGh/BI1Rw2zUbSXZvx5svtlKDnSjXq+uY9nTJiXMsrNFSTrhwKQUMn4xv0T4gKNpN4Fx1gARAAHyd7po7hvs8Ia202gH2tGqzkUnhEZ4nZ4BP1+EXsyR0uc7fzwIDAQAB";
