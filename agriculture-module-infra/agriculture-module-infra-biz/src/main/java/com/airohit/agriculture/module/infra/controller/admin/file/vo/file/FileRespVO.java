...
public class FileRespVO {
    ...
    @ApiModelProperty(value = "文件路径", required = true, example = "agriculture.jpg")
    private String path;

    @ApiModelProperty(value = "文件 URL", required = true, example = "https://www.airohit.cn/agriculture.jpg")
    private String url;
