package com.airohit.agriculture.module.infra.service.codegen.inner;
...
import com.airohit.agriculture.framework.common.util.object.ObjectUtils;
...
import com.airohit.agriculture.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "agriculture-module-${table.moduleName}/" + // 顶级模块
                "agriculture-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "agriculture-module-${table.moduleName}/" + // 顶级模块
                "agriculture-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "agriculture-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "agriculture-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
