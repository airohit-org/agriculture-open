package com.airohit.agriculture.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableBaseVO {
    ...
    @ApiModelProperty(value = "表名称", required = true, example = "agriculture")
    @NotNull(message = "表名称不能为空")
    private String tableName;

    @ApiModelProperty(value = "表描述", required = true, example = "农业")
    ...
    @ApiModelProperty(value = "作者", required = true, example = "shiminghao")
