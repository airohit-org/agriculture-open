  ...
  <div class="app-container">
    ...
    <el-form class="form" :model="queryParams" ref="queryFormRef" :inline="true" v-show="showSearch">
      ...
      <el-form-item>
        ...
        <el-button class="add" type="primary" plain icon="el-icon-plus" size="small" @click="handleAdd"
          v-hasPermi="['plant:plan:create']">新增</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-dialog center :title="title" v-model="plan" width="800px" append-to-body>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="180px">
        ...
        <el-form-item class="form-item" label="开始日期" prop="startTime">
          <el-date-picker v-model="form.startTime" format="YYYY/MM/DD" value-format="YYYY-MM-DD" placeholder="请选择" />
        </el-form-item>
...
import { createPlan, updatePlan, deletePlan, getPlan, getPlanPage, clonePlan, planPublish } from "@/api/plant/plan";
...
function addPlan() {
  proxy.$refs["formRef"].validate(valid => {
    ...
    if (isClone.value) {
      clonePlan(form.value).then(response => {
