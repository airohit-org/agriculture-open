package com.airohit.agriculture.module.plant.dal.dataobject.tasktemplateraking;
 ...
 * @author 史铭浩
 */
@TableName("agro_task_template_raking")
@KeySequence("agro_task_template_raking_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class TaskTemplateRakingDO extends BaseDO {
