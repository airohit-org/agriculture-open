 ...
 * 1）Spring Async：
 * {@link com.airohit.agriculture.framework.quartz.config.AgricultureAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 * 2）Spring Security：
 * TransmittableThreadLocalSecurityContextHolderStrategy
 * 和 AgricultureSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 */
package com.airohit.agriculture.framework.tenant;
