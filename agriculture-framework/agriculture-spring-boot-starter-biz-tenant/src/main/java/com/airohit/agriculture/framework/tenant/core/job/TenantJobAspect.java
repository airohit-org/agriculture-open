package com.airohit.agriculture.framework.tenant.core.job;
...
public class TenantJobAspect {
    ...
    private void execute(ProceedingJoinPoint joinPoint, XxlJob xxlJob) {
        ...
        tenantIds.parallelStream().forEach(tenantId -> { // TODO shiminghao：先通过 parallel 实现并行；1）多个租户，是一条执行日志；2）异常的情况
