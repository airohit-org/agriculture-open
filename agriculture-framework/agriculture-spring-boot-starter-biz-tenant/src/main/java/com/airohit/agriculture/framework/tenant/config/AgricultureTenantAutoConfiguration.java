...
import com.airohit.agriculture.framework.tenant.core.aop.TenantIgnoreAspect;
import com.airohit.agriculture.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.airohit.agriculture.framework.tenant.core.job.TenantJobAspect;
import com.airohit.agriculture.framework.tenant.core.redis.TenantRedisCacheManager;
import com.airohit.agriculture.framework.tenant.core.security.TenantSecurityWebFilter;
import com.airohit.agriculture.framework.tenant.core.service.TenantFrameworkService;
import com.airohit.agriculture.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.airohit.agriculture.framework.tenant.core.web.TenantContextWebFilter;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "agriculture.tenant", value = "enable", matchIfMissing = true)
// 允许使用 agriculture.tenant.enable=false 禁用多租户
@EnableConfigurationProperties({TenantProperties.class})
public class AgricultureTenantAutoConfiguration {
...
//    }
    ...
    public FilterRegistrationBean<TenantSecurityWebFilter> tenantSecurityWebFilter(TenantProperties tenantProperties,
        ...
        registrationBean.setFilter(new TenantSecurityWebFilter(tenantProperties, webProperties, farmTenantProperties,
