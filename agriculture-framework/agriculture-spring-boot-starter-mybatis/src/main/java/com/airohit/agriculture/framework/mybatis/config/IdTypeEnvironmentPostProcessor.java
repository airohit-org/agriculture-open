package com.airohit.agriculture.framework.mybatis.config;

import cn.hutool.core.util.StrUtil;
import com.airohit.agriculture.framework.common.util.collection.SetUtils;
import com.airohit.agriculture.framework.mybatis.core.enums.SqlConstants;
...
public class IdTypeEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        // TODO shiminghao：暂时没有找到特别合适的地方，先放在这里
