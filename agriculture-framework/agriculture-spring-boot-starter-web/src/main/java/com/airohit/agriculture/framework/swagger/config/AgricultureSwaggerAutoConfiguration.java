package com.airohit.agriculture.framework.swagger.config;

import com.airohit.agriculture.framework.swagger.core.SpringFoxHandlerProviderBeanPostProcessor;
...
import static com.airohit.agriculture.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
@ConditionalOnProperty(prefix = "agriculture.swagger", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(SwaggerProperties.class)
public class AgricultureSwaggerAutoConfiguration {
...
//                .apis(basePackage("com.airohit.agriculture.module.system")) // 可用于 swagger 无法展示时使用
