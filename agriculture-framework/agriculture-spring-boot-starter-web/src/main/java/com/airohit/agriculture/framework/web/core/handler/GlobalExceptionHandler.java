package com.airohit.agriculture.framework.web.core.handler;

import cn.hutool.core.exceptions.ExceptionUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.extra.servlet.ServletUtil;
import com.airohit.agriculture.framework.apilog.core.service.ApiErrorLog;
...
import static com.airohit.agriculture.framework.common.exception.enums.GlobalErrorCodeConstants.*;
...
//        }
    ...
    public CommonResult<?> methodArgumentNotValidExceptionExceptionHandler(MethodArgumentNotValidException ex) {
        ...
        return CommonResult.error(BAD_REQUEST.getCode(), String.format(Optional.ofNullable(fieldError.getDefaultMessage()).orElse("")));
    }
    ...
    public CommonResult<?> constraintViolationExceptionHandler(ConstraintViolationException ex) {
        ...
        return CommonResult.error(BAD_REQUEST.getCode(), String.format(constraintViolation.getMessage()));
    }
