package com.airohit.agriculture.framework.web.config;
...
import com.airohit.agriculture.framework.web.core.filter.CacheRequestBodyFilter;
import com.airohit.agriculture.framework.web.core.filter.DemoFilter;
import com.airohit.agriculture.framework.web.core.filter.XssFilter;
import com.airohit.agriculture.framework.web.core.handler.GlobalExceptionHandler;
import com.airohit.agriculture.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class AgricultureWebAutoConfiguration implements WebMvcConfigurer {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "agriculture.demo", havingValue = "true")
